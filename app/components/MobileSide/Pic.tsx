...
const Pic = () => {
  return (
    <div className="flex h-full w-full items-center justify-center pb-10 pt-32">
      <div className="relative flex h-70 w-70 items-center justify-center overflow-visible rounded-full border border-white bg-gradient-to-b from-white via-blue-50 to-teal-50 shadow-[0_24px_70px_rgba(37,99,235,0.18)]">
