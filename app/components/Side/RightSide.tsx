...
const RightSide = () => {
  return (
    <div className="flex justify-center items-center h-full">
      <div className="relative h-40 w-40 sm:h-60 sm:w-60 md:h-60 md:w-60 lg:h-[440px] lg:w-[440px] shadow-2xl shadow-white rounded-full overflow-visible flex items-center justify-center bg-gradient-to-b to-transparent from-white">
